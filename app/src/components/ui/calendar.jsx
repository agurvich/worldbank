  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-neutral text-text-contrast hover:bg-neutral hover:text-text-contrast focus:bg-neutral focus:text-text-contrast",
        day_today: "bg-brand text-text-neutral",
        day_outside:
          "day-outside text-text-secondary opacity-50 aria-selected:bg-brand/50 aria-selected:text-text-secondary aria-selected:opacity-30",
        day_disabled: "text-text-secondary opacity-50",
        day_range_middle:
          "aria-selected:bg-brand aria-selected:text-text-neutral",
